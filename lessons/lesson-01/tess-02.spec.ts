...
test.describe("Lesson 02 - Ex1",
      async () => {
            test.beforeEach(async ({ page }) => {
                  test.step('Truy cập trang https://material.playwrightvn.com/',
                        async () => {
...
test("Test 02 - Product page",
      async ({ page }) => {
            await test.step('Step 01s : click vào “Bài học 2: Product page”', 
                  async () => {
...
test("Test 03 : Todo page",
      async ({ page }) => {
            ...
            await test.step('Step 01s : click vào “Bài học 3: Todo page"', 
                  async () => {
